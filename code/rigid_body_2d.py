...
class GTVFRigidBody2DStep(IntegratorStep):
    def py_stage1(self, dst, t, dt):
        ...
        for i in range(dst.nb[0]):
            ...
            # omega_dot is
            dst.omega[i3 + 2] += dtb2 * dst.torque[i3 + 2] / dst.izz[i]
...
class RigidBody2DScheme(Scheme):
    def __init__(self, rigid_bodies, boundaries, dim,
        ...
        if self.dim != 2:
            ...
            print("#=================================================================#")
            print("#=================================================================#")
            print("#============The current scheme cannot be used to ================#")
            print("#============simulate problems other than 2 dimensions============#")
            print("#=================================================================#")
            print("#=================================================================#")
            print("#=================================================================#")
            print("#=================================================================#")
